...
if __name__ == '__main__':
    ...
    torch_files = list(Path(dataset_dir).rglob("*.torch"))
    dataset_path = args.dataset_path
    torch_path = "/Preproccessing/Datasets/re10k/try"
    save_folder = os.path.join(dataset_path, '../preprocess')

    # Cartella dove cercare i file .torch
    #dataset_dir = "/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess/"
    ...
    for directory in tqdm(data_list, desc="Processing files"):
        ...
        for directory in tqdm(data_list, desc="Processing files"):
            ...
            for file_name in tqdm(directory_data_list, desc="Processing files"):
                ...
                if os.path.exists(
                        f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess/{directory}/tiles/"):
                    path = f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess/{directory}/tiles/"
                    shutil.rmtree(path)
                if os.path.exists(
                        f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess/{directory}/SAM_vis/"):
                    path = f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess/{directory}/SAM_vis/"
                    shutil.rmtree(path)
                if os.path.exists(
                        f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess/{directory}/SAM/"):
                    path = f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess/{directory}/SAM/"
                    shutil.rmtree(path)
