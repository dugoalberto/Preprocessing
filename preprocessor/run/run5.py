...
from preprocessor.CLIP import OpenCLIPNetwork, OpenCLIPNetworkConfig
...
if __name__ == '__main__':
    ...
    img_folder = os.path.join(dataset_dir, 'images_training_5')
    ...
    for directory in tqdm(data_list, desc="Processing files"):
        ...
        for directory in tqdm(data_list, desc="Processing files"):
            ...
            for file_name in tqdm(directory_data_list, desc="Processing files"):
                ...
                if os.path.exists(
                        f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess_training/{directory}/tiles/"):
                    path = f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess_training/{directory}/tiles/"
                    shutil.rmtree(path)
                if os.path.exists(
                        f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess_training/{directory}/SAM_vis/"):
                    path = f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess_training/{directory}/SAM_vis/"
                    shutil.rmtree(path)
                if os.path.exists(
                        f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess_training/{directory}/SAM/"):
                    path = f"/mnt/home/albertodugo/Projects/Preproccessing/preprocessor/preprocess_training/{directory}/SAM/"
                    shutil.rmtree(path)
